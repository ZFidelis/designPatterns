...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Character e1 = new Enemy("Goblin 1", 10, 10, 3, 5, 1);
        Character e2 = new Enemy("Goblin 2", 10, 10, 3, 5, 1);
        targets.add(e1);
        targets.add(e2);
        ...
        for(int i = 1; i <= rounds; i++) {
            ...
            switch(actChoice) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    System.out.println("TODO: Implementar ataque simples");
                    break;
                default:
    ...
    public static Weapon weaponMenu() {
        ...
        switch(wpChoice) {
            case 1:
                selectedWeapon = new ElvenBow();
                break;
            case 2:
                selectedWeapon = new ArcaneStaff();
                break;
            case 3:
                selectedWeapon = new HolyHammer();
                break;
            case 4:
                selectedWeapon = new LongSword();
                break;
            case 5:
                selectedWeapon = new ShadowDagger();
                break;
            case 6:
                selectedWeapon = new WarAxe();
                break;
            default:
                break;
        }
